  ...
  <div v-if="!showGeneratePasswordForm">
    <form @submit.prevent="handleSubmit">
      <div class="form-group">
        ...
        <input class="form-control" type="text" id="passwordName" required v-model="passwordName" />
      </div>
      <br />
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="password" required v-model="password" />
      </div>
      <p class="mt-3">
        <button class="btn btn-secondary btn-sm" @click="generatePassword" v-if="!showGeneratePasswordForm">Generate
          Password</button>
      </p>
      <hr />
      <div class="text-center">
        <button class="btn btn-primary">Add password</button>
        <button class="btn btn-secondary ms-2" @click.prevent="store.changeCurrentView('Passwords')">Cancel</button>
      </div>
    </form>
  </div>
